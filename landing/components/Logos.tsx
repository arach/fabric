  ...
  return (
    <div className="w-full flex justify-center">
      <div className="flex items-center gap-16 md:gap-24">
        {/* Daytona - logo has wordmark */}
        <a href="/daytona" className="flex items-center justify-center opacity-60 hover:opacity-100 transition-opacity duration-300 grayscale hover:grayscale-0">
          <img src="https://github.com/daytonaio/daytona/raw/main/assets/images/Daytona-logotype-white.png" alt="Daytona" className="h-6 w-auto" />
        </a>

        {/* E2B */}
        <a href="/e2b" className="flex items-center justify-center min-w-[120px] md:min-w-[160px] opacity-40 hover:opacity-100 transition-opacity duration-300 grayscale hover:grayscale-0 group">
          <div className="h-8 w-auto text-white fill-current flex items-center gap-3">
            ...
            <span className="font-semibold text-lg tracking-tight hidden md:block">E2B</span>
          </div>
        </a>

        {/* exe.dev */}
        <a href="/exe" className="flex items-center justify-center min-w-[120px] md:min-w-[160px] opacity-40 hover:opacity-100 transition-opacity duration-300 grayscale hover:grayscale-0 group">
          <div className="h-8 w-auto text-white fill-current flex items-center gap-3">
            <img src="https://exe.dev/static/exy.png" alt="exe.dev" className="h-8 w-auto" />
            <span className="font-semibold text-lg tracking-tight hidden md:block">exe.dev</span>
          </div>
        </a>
      </div>
    </div>
