...
const STEPS = [
  ...
  { text: 'fabric shell --image ubuntu', delay: 1200 },
  { text: 'Launching Ubuntu 24.04 (dev tools)...', output: true, color: 'text-cyan-400', delay: 400 },
  { text: 'Image: fabric-ubuntu:latest', output: true, delay: 300 },
